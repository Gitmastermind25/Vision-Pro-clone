...
// we made a fucntion which is canavs 
function canvas(){
//by const canvas we select tag of canvas of page7
  const canvas = document.querySelector("#page7>canvas");
//we select all the tool of canvas
const context = canvas.getContext("2d");

//we select the height width of canavs
canvas.width = window.innerWidth;
canvas.height = window.innerHeight;

//we resize the height width of canavs when we are changing the parameters
...
//we made a fuction which is files and passed a parameter called index , all the images are stored in variable called data
function files(index) {
 ...
 `;
 //images are basically in form of string which is coverted into iamge by this line
  return data.split("\n")[index];
}
//we used 199 frames
const frameCount = 199;
//all images tags are stored here(array)
const images = [];
//when canvas is called frame1 will display
const imageSeq = {
  frame: 1,
};
// this for loop will give all the imagetag and push these images into array
...
//on refreshing render first image
